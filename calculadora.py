...
if notas > 5.0: 
    print(f"A sua nota na disciplina de TED 1 foi {notas}. Parabéns, voce esta aprovado!")
else: 
    print(f"A sua nota na disciplina de TED 1 foi {notas}. Infelizmente, voce esta reprovado!")